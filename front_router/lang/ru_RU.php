...
$i18n = array(
  ...
  'PLUGIN_DESC'    => 'Create front-end routes page routes', // Requires revision
  'MANAGE_ROUTES'  => 'Управление маршрутами',

  // admin
  'INIT_ERROR'            => 'Ошибка инициализации плагина!',
  'MKDIR_ERROR'           => 'Не удалось создать папку %folder%',
  'HTACESS_ERROR'         => 'Не удалось создать файл %htaccess%',
